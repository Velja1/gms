                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    ...
                    @csrf
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="tbFirstName" name="firstname" class="form-control form-control-lg" />
                            <label class="form-label" for="tbFirstName">First name</label>
                        </div>

                        <!-- Last name input -->
                        <div class="form-outline mb-4">
                            <input type="text" id="tbLastName" name="lastname" class="form-control form-control-lg" />
                    ...
                    <a class="btn btn-info btn-lg btn-block mt-4" href="{{route('login')}}">Login</a>
                </div>
            </div>
        </div>
    </section>
